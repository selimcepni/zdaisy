		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Daisy Fiori Application",
									"targetURL": "#sapcomsapportzdaisy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomsapportzdaisy-display": {
								"semanticObject": "sapcomsapportzdaisy",
								"action": "display",
								"description": "Daisy Fiori Application",
								"title": "Daisy Fiori Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.sapport.zdaisy",
									"url": sap.ui.require.toUrl("sap/com/sapport/zdaisy")
								}
							}
						}
					}
